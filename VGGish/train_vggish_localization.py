...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=256, help='Size of batches')
    parser.add_argument('--num_epochs', type=int, default=2, help='Number of batch iterations')
